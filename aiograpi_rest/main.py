...
OPERATION_SUMMARIES = {
    ...
    "getAccountFeedNew": "Check whether the account has new feed items",
    "getAccountFeedTimeline": "Get authenticated timeline feed",
    "getAccountFeedUserStreamItem": "Get user feed stream item",
    "getAccountFamily": "Get authenticated account family",
    "getAccountSecurity": "Get authenticated account security info",
    "getAccountFollowRequests": "List paginated pending follow requests",
    "postAccountFollowRequestsApprove": "Approve pending follow requests",
    "deleteAccountFollowRequests": "Decline pending follow requests",
    ...
    "patchAccountBiography": "Update authenticated account biography",
    "patchAccountExternalUrl": "Update authenticated account external URL",
    "deleteAccountExternalUrl": "Clear authenticated account external URL",
    "deleteAccountBioLinks": "Remove authenticated account bio links",
    "patchAccountPassword": "Change authenticated account password",
    "postAccountPasswordReset": "Request account password reset",
    "postAccountEmailConfirm": "Confirm authenticated account email",
    "postAccountEmailConfirmation": "Send authenticated account email confirmation",
    "postAccountPhoneConfirm": "Send account phone confirmation",
    ...
    "postMediaLivestream": "Create livestream",
    "getMediaLivestream": "Get livestream info",
    "patchMediaLivestream": "Update livestream state",
    "getMediaLivestreamComments": "List livestream comments",
    "getMediaLivestreamViewers": "List livestream viewers",
    "postMediaNote": "Create media note",
    "deleteMediaNote": "Delete media note",
    ...
    "getMusicSearch": "Search current music catalog",
    "getMusicKeywords": "Search music keywords",
    "getMusicTrending": "Get trending music",
    "getMusicTrendsTop": "Get top music trends",
    "getMusicClipsBrowser": "Browse Reel music",
    "postMusicBookmark": "Bookmark music",
    "getMusicOriginalAudioTitleAvailability": "Check original audio title availability",
    ...
    "getDirectRequestsPreview": "Get Direct requests preview",
    "getDirectPendingInbox": "List direct pending inbox threads",
    "getDirectSpam": "List paginated direct spam threads",
    "getDirectSpamInbox": "List direct spam inbox threads",
    "getDirectThreads": "List direct threads",
    "getDirectChannels": "List Direct channels",
    "getDirectInteropUpgraded": "Check Direct interop upgrade",
    "getDirectGenaiBots": "Search Direct GenAI bot suggestions",
    "patchDirectE2eeEligibility": "Set Direct E2EE eligibility",
    "getDirectThread": "Get direct thread details",
    "getDirectThreadByParticipants": "Find a direct thread by participants",
    "postDirectThreadMessage": "Reply in a direct thread",
    ...
    "deleteDirectMessage": "Unsend a direct message",
    ...
    "postDirectRequestApprove": "Approve a direct message request",
    ...
    "getSearchItem": "Search one Instagram result tab",
    ...
    "getSearchSuggestedUsers": "List suggested users for a profile",
    "getSearchTop": "Search top results",
    "getSearchTopFlat": "Search flat top results",
    "getSearchTypeahead": "Get search autocomplete suggestions",
    "getSearchTypeaheadStream": "Get raw search typeahead stream",
    ...
    "postPhotoUploadWithMusic": "Upload a feed photo with music",
    ...
    "getClipCreationInfo": "Get Reel creation info",
    "getClipTrialEligibility": "Check Trial Reels eligibility",
    "getClipShareFacebookConfig": "Get Reel Facebook sharing config",
    "getClipDownload": "Download a Reel",
    "getClipDownloadByUrl": "Download a Reel from a URL",
    "getClipTemplate": "Get clip template",
    "postClipPin": "Pin a Reel",
    "deleteClipPin": "Unpin a Reel",
    "postClipUpload": "Upload a Reel",
    "postClipUploadByUrl": "Upload a Reel from a URL",
    "postClipUploadWithMusic": "Upload a Reel with music",
    ...
    "postAlbumUploadWithMusic": "Upload a carousel album with music",
    ...
    "getUserProfileWeb": "Get user web profile",
    "getUserStream": "Get user profile stream",
    "getUserCreator": "Get creator info for a user",
    "getUserFeaturedAccounts": "Get featured accounts for a user",
    "getUserFundraiser": "Get fundraiser info for a user",
    "getUserRecommendations": "List recommended accounts for a user",
    "getUserSuggestions": "List suggested users for a user",
    "getUserSuggestionsDetails": "Get suggested user details",
    ...
    "getUserFriendships": "List user relationships",
    ...
    "getNotes": "List notes",
    "getNotesMusicBrowser": "Browse note music",
    "patchNotesLastSeen": "Mark notes as seen",
    "getNote": "Get note by username",
    "postNote": "Create a note",
    "postNoteMusic": "Create music note",
    "getNoteText": "Get note text by username",
