...
| `POST /module/v1/jobs` | - |
| `GET /module/v1/jobs/{job_id}` | - |
| `POST /module/v1/jobs/{job_id}/cancel` | - |
| `POST /module/v1/jobs/{job_id}/input` | - |
| `POST /module/v1/jobs/{job_id}/pause` | - |
| `POST /module/v1/jobs/{job_id}/resume` | - |
